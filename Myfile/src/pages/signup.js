...
const Signup = () => {
  ...
  async function signupxx(){
   ...
   const options={
    ...
    const url =("http://192.168.1.27:8080/api/signup/user")
    try{
...
console.log(mess)
      if(response.ok){
        ...
        console.log("failed")
      swal(`Failed To Signup ${mess}`, "Error", "error")
      }
      }catch(error) {
        console.error(error);
      }
...
/>   {errors.countryx && <p >{errors.countryx.message}</p>}
          ...
          <div className="form-inputs">
            ...
            <input
              ...
              value={birthDay}
              {...register("birthdate", { required: true, maxLength: 30 })}
              onChange={(e) => setBirth(e.target.value)}
              
            />
             {errors.birthdate && <p >BirthDate is Required</p>}
          </div>
          ...
          <div className="form-inputs">
            ...
            <input
              ...
              value={gender}
              {...register("gender", { required: true, maxLength: 30 })}
